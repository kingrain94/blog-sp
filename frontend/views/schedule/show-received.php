    ...
    <div class="col-md-8">
        <div class="box box-info">
            ...
            <div class="box-footer">
                <a href="?r=schedule/decline-received-schedule&id=<?= $model['id'] ?>" class="btn btn-default">Bỏ qua</a>
                <a href="?r=schedule/accept-received-schedule&id=<?= $model['id'] ?>" class="btn btn-info pull-right">Thêm vào lịch</a>
            </div><!-- /.box-footer -->
        </div>
    </div>
</div>
